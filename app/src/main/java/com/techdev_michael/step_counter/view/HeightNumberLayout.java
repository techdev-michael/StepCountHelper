package com.techdev_michael.step_counter.view;
...
public class HeightNumberLayout extends RelativeLayout implements RulerCallback {
    ...
    //kg单位文字
    private String mUnitText = "cm";

    private BooheeRuler mRuler;


    public HeightNumberLayout(Context context) {
        super(context);
        init(context);
    }

    public HeightNumberLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(context, attrs);
        init(context);
    }

    public HeightNumberLayout(Context context, AttributeSet attrs, int defStyleAttr) {
