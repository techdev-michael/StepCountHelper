...
public class AgeNumberLayout extends RelativeLayout implements RulerCallback {
    ...
    //kg单位文字
    private String mUnitText = "岁";

    private BooheeRuler mRuler;


    public AgeNumberLayout(Context context) {
        super(context);
        init(context);
    }

    public AgeNumberLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(context, attrs);
        init(context);
    }

    public AgeNumberLayout(Context context, AttributeSet attrs, int defStyleAttr) {
