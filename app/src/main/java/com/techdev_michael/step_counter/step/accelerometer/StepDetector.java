...
//            Log.e(TAG, "onSensorChanged: 角速度传感器 event.values[0] ： "
//                    + event.values[0] + "  event.values[1] : " + event.values[1] + "  event.values[2] : " + event.values[2]);
...
//            Log.e(TAG, "onSensorChanged: X 轴旋转角度 ： " + orientations[0] + " Y 轴旋转角度 ： " + orientations[1] + "  Z 轴旋转角度 ： " + orientations[2] );
